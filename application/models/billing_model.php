...
public function get_idcatmember()
	...
	public function register_member($member){
		$this->db->insert('membership',$member);
	}

	public function save_customer($customersave){
		$this->db->insert('tbl_savecustomer',$customersave);
	}
